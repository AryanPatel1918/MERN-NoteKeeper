    ...
    <div className="max-w-7xl mx-auto px-4 py-8">
      <div className="bg-primary/20 border border-primary rounded-lg shadow-md">
        <div className="flex flex-col md:flex-row items-center p-6">
          <div className="flex-shrink-0 bg-primary/20 border border-primary p-4 rounded-full mb-4 md:mb-0 md:mr-6">
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <p className="text-base-content/70">This ensures the best experience.</p>
          </div>
        </div>
      </div>
    </div>
